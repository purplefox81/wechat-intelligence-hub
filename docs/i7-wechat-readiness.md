...
人工发送 `watch-1`、`watch-2`、`watch-3` 后，8 秒监听在 9 次轮询中捕获 3 条；正文顺序精确匹配、事件 ID 唯一、时间顺序正确，来源与覆盖均为 macOS `incoming_preview_only`。随后 3 秒复查完成 7 次轮询、捕获 0 条，确认断点去重有效。`events.jsonl` 权限为 `0600`，正文仅保存在 i7 私有目录。
